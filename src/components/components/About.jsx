    ...
    <section>
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="max-w-screen-sm sm:text-center sm:mx-auto">
          ...
          When we started this system it was not really easy
          for us as a team but at the earn of the day we succeded 
          so enjoy our system at your school or business place with joy. 
          </p>
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
            ...
            <div className="max-w-xl mb-6">
              ...
              Real time elearning system is a good system that makes 
              it easy for teachers and students to communicates easily.
              </p>
            </div>
          </div>
     ...
     data-aos-duration="1000">
        <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            ...
            <p className="text-base text-gray-700 md:text-lg">
              In life you have to be ready for chanllenges in what ever 
              you are working on.
            </p>
          </div>
        </div>
